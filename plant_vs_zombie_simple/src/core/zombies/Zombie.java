...
public abstract class Zombie {
	...
	public void Zombie(int x,int y,String name,int health,List<ZombieHead> head_group,int damage) {
...
//  the zombie is hypo&&attack other zombies when it ate a HypnoShroom
    ...
    // public void loadFrames(frames,String name, image_x, colorkey=c.BLACK) {}
    ...
    public void walking() {
        ...
        else if( this.health <= c.LOSTHEAD_HEALTH&&not this.losHead) {
    ...
    public void freezing() {
        ...
        if ((this.current_time - this.freeze_timer) > c.FREEZE_TIME) {
            this.setWalk();
		}
	}
    ...
    public void setAttack( prey, is_plant=true) {
